...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let sdkKey = "D05YiAUMAoSct32MqFxKpiQmnelAxKeVfju2"
    let sdkSecret = "JnGqK6lUcJWlkyStFf2q30PWXik6Bk00Zqip"
    ...
    func setupSDK(sdkKey: String, sdkSecret: String) {
        ...
        mobileInitContext.domain = "zoom.us"
        mobileInitContext.appGroupId = "group.com.selayarsoft.MobileRTCSample"
        ...
        let sdkInitializedSuccessfully = MobileRTC.shared().initialize(mobileInitContext)
