...
class ViewController: UIViewController {
    ...
    func presentJoinMeetingAlert() {
        let alertController = UIAlertController(title: "Gabung Bimbingan", message: "", preferredStyle: .alert)

        alertController.addTextField { (textField : UITextField!) -> Void in
            textField.placeholder = "Bimbingan number"
            textField.keyboardType = .phonePad
        }
        alertController.addTextField { (textField : UITextField!) -> Void in
            textField.placeholder = "Bimbingan password"
            textField.keyboardType = .asciiCapable
            textField.isSecureTextEntry = true
        }

        let joinMeetingAction = UIAlertAction(title: "Gabung", style: .default, handler: { alert -> Void in
    ...
    func presentLogInAlert() {
        let alertController = UIAlertController(title: "Mulai Bimbingan", message: "", preferredStyle: .alert)
        ...
        let logInAction = UIAlertAction(title: "Mulai", style: .default, handler: { alert -> Void in
